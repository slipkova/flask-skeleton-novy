...
Revision ID: 437ab24d1952
Revises: None
Create Date: 2020-09-30 11:05:51.969855

"""

# revision identifiers, used by Alembic.
revision = '437ab24d1952'
down_revision = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='pk_stonks'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_stonks_short', 'stonks', ['short'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_stonks_short', table_name='stonks')
